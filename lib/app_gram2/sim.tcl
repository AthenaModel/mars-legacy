...
#
# PACKAGE:
#   app_gram2(n) -- mars_gram2(1) implementation package
#
# PROJECT:
...
# Module: sim
#
# The sim module manages the simulation proper: the gramdb2(5)
...
snit::type sim {
    ...
    # Notifier Event: Load
    #
    # A new gramdb2(5) database has been loaded.  A <Reset> is also sent.
    ...
    #
    # The gramdb2(5) data has been deleted and the simulation uninitialized.
    ...
    # Type Component: ram
    #
    # The current gram2(n) instance, or <NullGram> if no gram2(n)
    ...
    # keys are as follows.
    #
    #   dbloaded - 1 if a gramdb2(5) is loaded, and 0 otherwise
    #   dbfile   - Name of the loaded gramdb2(5) file, or "" if none.
    ...
    # can't be done until the user specifies a gramdb2(5) file, and
    ...
    #   sim load _dbfile_
    #
    #   dbfile - The name of a gramdb2(5) database file.
    ...
    #
    # Creates the gram2(n) object, and initializes it using the currently
    # loaded gramdb2(5) data.
    ...
    # Type method: dbfile 
    #
    # Returns the name of the loaded gramdb2(5) file, or "" if not
    # <dbloaded>.
    ...
    # Type method: cancel
    #
    # Cancels the effects of a gram2(n) _driver_ given its ID.
    ...
    #
    # Syntax:
    #   sim coop adjust _f g mag ?options...?_
    #
    ...
    #
    # Options:
    # -driver driver - A gram2(n) driver ID

    typemethod "coop adjust" {f g mag args} {
        ...
        $ram coop adjust $driver $f $g $mag
    }
    ...
    #
    # Syntax:
    #   sim coop level _f g limit days ?options?_
    #
    ...
    typemethod "coop level" {f g limit days args} {
        set driver [sim GetDriver args]
        set ts     [sim GetStartTime args]

        $ram coop level $driver $ts $f $g $limit $days {*}$args
    ...
    #
    # Syntax:
    #   sim coop slope _f g slope limit ?options...?_
    #
    #   f     - The targeted civilian group
    #   g     - The targeted force group
    ...
    typemethod "coop slope" {f g slope args} {
        set driver [sim GetDriver args]
        set ts     [sim GetStartTime args]

        $ram coop slope $driver $ts $f $g $slope {*}$args
    ...
    #
    # Syntax:
    #   sim sat adjust _g c mag ?options?_
    #
    ...
    typemethod "sat adjust" {g c mag args} {
    ...
    #
    # Syntax:
    #   sim sat level _g c limit days ?options?_
    #
    ...
    typemethod "sat level" {g c limit days args} {
        set driver [sim GetDriver args]
        set ts     [sim GetStartTime args]

        $ram sat level $driver $ts $g $c $limit $days {*}$args
    ...
    #
    # Syntax:
    #   sim sat slope _g c slope ?options...?_
    #
    #   g     - The targeted group
    #   c     - The affected concern
    #   slope - change/day (qmag)
    ...
    typemethod "sat slope" {g c slope args} {
        set driver [sim GetDriver args]
        set ts     [sim GetStartTime args]

        $ram sat slope $driver $ts $g $c $slope {*}$args
