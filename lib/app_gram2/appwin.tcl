...
snit::widget appwin {
    ...
    typeconstructor {
        ...
        # Icon: icon::step
        #
        # Represents a figure of a man stepping forward.
    ...
    variable tabs {
        ...
        gramdb_frcg {
            label  frc_g
            parent gramdb
            script { gramdb_tab %W gramdb_frc_g 1 }
        }

        gramdb_civg {
            label  civ_g
            parent gramdb
            script { gramdb_tab %W gramdb_civ_g 1 }
        }
        ...
        gramdb_civfg {
            label  civ_fg
            parent gramdb
            script { gramdb_tab %W gramdb_civ_fg 2 }
        }
        
        gramdb_frcfg {
            label  frc_fg
            parent gramdb
            script { gramdb_tab %W gramdb_frc_fg 2 }
        }

        gramdb_coopfg {
            label  coop_fg
            parent gramdb
            script { gramdb_tab %W gramdb_coop_fg 2 }
        }
    ...
    #
    #   win          - The window name
    #   name         - The name of a gram2(n) table or view
    ...
    # for a gramdb2(5) table.
    #
    # Syntax:
    #   gram_tab _win name tc ?option value...?_
    #
    #   win          - The window name
    #   name         - The name of a gramdb2(5) table or view
    #   tc           - Number of title columns
    #   option value - sqlbrowser(n) options and their values.
    ...
    constructor {args} {
        ...
        wm title $win "GRAM Workbench V2"
    ...
    #
    # File/Load gramdb2(5) File... menu item.
    #
    ...
    method FileLoadGramdb {} {
        set name [tk_getOpenFile \
                      -defaultextension ".gramdb2"                 \
                      -filetypes        {{gramdb2(5) {.gramdb2}}}   \
                      -parent           .                         \
                      -title            "Load gramdb2(5) File..."]
